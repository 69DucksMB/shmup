...
# Mark Balagtas
# 6/10/2021
# Learning and following along on the tutorials given in class to create a shmup game
# ========================== #
...
pygame.init() # inits the game and make da window
pygame.mixer.init()
screen = pygame.display.set_mode((WIDTH, HEIGHT))
pygame.display.set_caption("Bruh!") # window caption
